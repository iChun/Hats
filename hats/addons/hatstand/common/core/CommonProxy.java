...
public class CommonProxy 
{
	...
	public void initMod()
	{
		HatStand.blockHatStand = (new BlockHatStand(HatStand.blockHatStandID, Material.wood)).setHardness(0.5F).setCreativeTab(CreativeTabs.tabDecorations).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("wood");
