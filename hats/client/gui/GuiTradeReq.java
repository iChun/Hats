        ...
        if (this.unlockedTime != 0L)
        {
            ...
            else
            {
                ...
                for(int ii = 0; ii < theGame.theWorld.playerEntities.size(); ii++)
                {
                	...
                	if(player.username.equalsIgnoreCase(this.hatNameText))
                	{
                ...
                if(rl != null)
                {
                    ...
                    tessellator.addVertexWithUV((double)(i + xOff + 0), (double)(j + yOff + size), (double)this.zLevel, 8D / 64D, 16D / 32D);
                    tessellator.addVertexWithUV((double)(i + xOff + size), (double)(j + yOff + size), (double)this.zLevel, 16D / 64D, 16D / 32D);
                    tessellator.addVertexWithUV((double)(i + xOff + size), (double)(j + yOff + 0), (double)this.zLevel, 16D / 64D, 8D / 32D);
                    tessellator.addVertexWithUV((double)(i + xOff + 0), (double)(j + yOff + 0), (double)this.zLevel, 8D / 64D, 8D / 32D);
                    tessellator.draw();
