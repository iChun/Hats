	...
	implements ISimpleBlockRenderingHandler 
{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) 
	{
		if(block instanceof BlockHatStand)
		{
            ...
            renderer.renderFaceYNeg(stand, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(stand, 0));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, 1.0F, 0.0F);
            renderer.renderFaceYPos(stand, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(stand, 1));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, 0.0F, -1.0F);
            renderer.renderFaceZNeg(stand, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(stand, 2));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, 0.0F, 1.0F);
            renderer.renderFaceZPos(stand, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(stand, 3));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(-1.0F, 0.0F, 0.0F);
            renderer.renderFaceXNeg(stand, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(stand, 4));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(1.0F, 0.0F, 0.0F);
            renderer.renderFaceXPos(stand, 0.0D, 0.0D, 0.0D, renderer.getBlockIconFromSide(stand, 5));
            tessellator.draw();
