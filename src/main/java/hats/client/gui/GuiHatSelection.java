	...
	implements ISlider
{
    ...
    protected void actionPerformed(GuiButton btn)
    {
    	...
    	{
            PacketHandler.sendToServer(Hats.channels, new PacketString(1, Hats.proxy.tickHandlerClient.tradeReq));
    ...
    public void exitAndUpdate()
    {
		...
		else if(!(player == null || player.isDead || !player.isEntityAlive()))
		{
            ...
            PacketHandler.sendToServer(Hats.channels, new PacketPlayerHatSelection(hat.hatName, colourR, colourG, colourB, alpha));
		}
    }
    ...
    public void drawForeground(int par1, int par2, float par3)
    {
        ...
        {
            GuiButton btn = (GuiButton)this.buttonList.get(k1);
            if(btn.func_146115_a() && !personalizing)
            {
