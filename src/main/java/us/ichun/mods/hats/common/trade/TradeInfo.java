...
public class TradeInfo
{
    ...
    {
        Hats.channel.sendToPlayer(new PacketString(3, trader1.getCommandSenderName()), trader2);
        Hats.channel.sendToPlayer(new PacketString(3, trader2.getCommandSenderName()), trader1);
        return this;
    }
    ...
    public void sendTradeMessage(String message, EntityPlayer...players)
    {
        ...
        {
            Hats.channel.sendToPlayer(new PacketString(2, message), player);
        }
    }

    public void sendReadyInfo()
    {
        Hats.channel.sendToPlayer(new PacketTradeReadyInfo(trader1.getCommandSenderName(), ready1, trader2.getCommandSenderName(), ready2), trader1);
        Hats.channel.sendToPlayer(new PacketTradeReadyInfo(trader1.getCommandSenderName(), ready1, trader2.getCommandSenderName(), ready2), trader2);
    }
    ...
    {
        Hats.channel.sendToPlayer(new PacketTradeOffers(hats, items), getOtherPlayer(player));
