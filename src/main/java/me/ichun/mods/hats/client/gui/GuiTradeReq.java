...
public class GuiTradeReq extends Gui
{
    ...
    public GuiTradeReq(Minecraft par1Minecraft)
    {
        ...
        this.headerText = "\u00A7e" + I18n.format("hats.trade.newTradeRequest");
        hatNameText = "";
    }
    ...
    public void updateGui()
    {
        ...
        if (this.unlockedTime != 0L)
        {
            ...
            else
            {
                ...
                this.theGame.fontRendererObj.drawString(I18n.format("hats.trade.tradeRequestDesc", GameSettings.getKeyDisplayString(Hats.config.guiKeyBind.keyIndex)), i + 30, j + 18, -1);
                ...
                if(rl != null)
                {
                    ...
                    buffer.pos((i + xOff + 0), (j + yOff + size), (double)this.zLevel);
                    buffer.pos((i + xOff + size), (j + yOff + size), (double)this.zLevel);
                    buffer.pos((i + xOff + size), (j + yOff + 0), (double)this.zLevel);
                    buffer.pos((i + xOff + 0), (j + yOff + 0), (double)this.zLevel); //TODO is this right?
                    buffer.endVertex();
                    tessellator.draw();
