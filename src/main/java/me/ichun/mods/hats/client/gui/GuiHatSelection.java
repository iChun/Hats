...
public class GuiHatSelection extends GuiScreen implements GuiSlider.ISlider
{
	...
	public GuiHatSelection(EntityPlayer ply)
	{
		...
		player = ply;
		hat = Hats.proxy.tickHandlerClient.hats.get(player.getName());
    ...
    public void onSearch()
    {
    	if(adding || renaming)
    	{
    		...
    		if(searchBar.getText().equalsIgnoreCase("Favourites") || searchBar.getText().equalsIgnoreCase(I18n.format("hats.gui.allHats")) || searchBar.getText().equalsIgnoreCase(I18n.format("hats.gui.addNew")))
    		{
				searchBar.setTextColor(0xFF5555);
				invalidFolderName = true;
    		}
    	...
    	{
	    	if(searchBar.getText().equalsIgnoreCase("") || !hasClicked && searchBar.getText().equalsIgnoreCase(I18n.format("hats.gui.search")))
	    	{
	    		searchBar.setTextColor(14737632);
        		...
        		{
        			hatsToShow.add(0, I18n.format("hats.gui.allHats"));
        			hatsToShow.add(I18n.format("hats.gui.addNew"));
        		}
	    	}
	    	else
	    	{
	    		...
	    		{
	    			if(view == VIEW_CATEGORIES && (s.equalsIgnoreCase(I18n.format("hats.gui.allHats")) || s.equalsIgnoreCase(I18n.format("hats.gui.addNew"))))
	    			{
	    				continue;
	    			}
    ...
    public void onSearchBarInteract()
    {
        ...
        {
        	searchBar.setTextColor(14737632);
        	if(!hasClicked && searchBar.getText().equalsIgnoreCase(I18n.format("hats.gui.search")))
        	{
        		hasClicked = true;
        		searchBar.setText("");
        		onSearch();
    ...
    protected void actionPerformed(GuiButton btn)
    {
    	...
    	{
    		FMLClientHandler.instance().displayGuiScreen(Minecraft.getMinecraft().player, new GuiTradeMaker());
    		return;
    	}
    	else if(btn.id == ID_ACCEPT_TRADE && Hats.proxy.tickHandlerClient.tradeReq != null && Hats.proxy.tickHandlerClient.tradeReqTimeout > 0)
    	{
            Hats.channel.sendToServer(new PacketString(1, Hats.proxy.tickHandlerClient.tradeReq));
    	...
    	if(personalizing)
    	{
	    	...
	    	else if(btn.id == ID_SET_FP)
	    	{
	    		...
	    		btn.displayString = I18n.format("hats.gui.firstPerson") + ": " + (Hats.config.renderInFirstPerson == 1 ? I18n.format("gui.yes") : I18n.format("gui.no"));
                Hats.config.save();
	    	}
	    	else if(btn.id == ID_SHOW_HATS)
	    	{
	    		Hats.config.renderHats = Hats.config.renderHats == 1 ? 0 : 1;
	    		btn.displayString = I18n.format("hats.gui.showHats") + ": " + (Hats.config.renderHats == 1 ? I18n.format("gui.yes") : I18n.format("gui.no"));
                Hats.config.save();
	    	}
    	...
    	else
    	{
	    	...
	    	else if(btn.id == ID_ADD)
	    	{
	    		...
	    		{
	    			if(view == VIEW_CATEGORY && !category.equalsIgnoreCase("Favourites") && !category.equalsIgnoreCase(I18n.format("hats.gui.contributors")))
	    			{
	    	...
	    	else if(btn.id >= ID_CATEGORIES_START)
	    	{
	    		...
	    		{
		    		if(btn.displayString.equalsIgnoreCase(I18n.format("hats.gui.addNew")))
		    		{
		    			updateButtonList();
		    		...
		    		else if(isShiftKeyDown() && !btn.displayString.equalsIgnoreCase(I18n.format("hats.gui.allHats")) && !btn.displayString.equalsIgnoreCase(I18n.format("hats.gui.contributors")))
		    		{
		    			updateButtonList();
    ...
    public void exitAndUpdate()
    {
		...
		{
            Hats.proxy.tickHandlerClient.playerWornHats.put(player.getName(), new HatInfo(hat.hatName, colourR, colourG, colourB, alpha));
    ...
    public void updateButtonList()
    {
        ...
        if(!personalizing)
        {
	    	if(view == VIEW_HATS || view == VIEW_CATEGORIES || view == VIEW_CATEGORY)
	    	{
		        ...
		        currentDisplay = (view == VIEW_HATS ? I18n.format("hats.gui.allHats") : view == VIEW_CATEGORY ? I18n.format("hats.gui.category") + " - " + category : I18n.format("hats.gui.categories")) + " (" + (pageNumber + 1) + "/" + (pageCount) + ")";
	    	}
	    	else if(view == VIEW_COLOURIZER)
	    	{
	    		...
	    		for(int i = 0; i < 4; i++)
	    		{
	    			GuiButton btn = new GuiSlider(i == 3 ? 29 : 5 + i, width / 2 - 6, height / 2 - 78 + (22 * button), 88, 0, i == 0 ? I18n.format("item.fireworksCharge.red") + ": " : i == 1 ? I18n.format("item.fireworksCharge.green") + ": " : i == 2 ? I18n.format("item.fireworksCharge.blue") + ": " : I18n.format("hats.gui.alpha") + ": ", "", 0, 255, i == 0 ? colourR : i == 1 ? colourG : i == 2 ? colourB : alpha, false, true, this);
	    			buttonList.add(btn);
	    			
	    			button++;
	    		}
	    		
	    		currentDisplay = I18n.format("hats.gui.colorizer");
	    	}
        ...
        else
        {
        	...
        	buttonList.add(new GuiButton(ID_SET_FP, width / 2 - 6, height / 2 - 78 + 22, 88, 20, I18n.format("hats.gui.firstPerson") + ": " + (Hats.config.renderInFirstPerson == 1 ? I18n.format("gui.yes") : I18n.format("gui.no"))));
        	buttonList.add(new GuiButton(ID_SHOW_HATS, width / 2 - 6, height / 2 - 78 + (22 * 2), 88, 20, I18n.format("hats.gui.showHats") + ": " + (Hats.config.renderHats == 1 ? I18n.format("gui.yes") : I18n.format("gui.no"))));
        	buttonList.add(new GuiButton(ID_RESET_SIDE, width / 2 - 6, height / 2 - 78 + (22 * 5), 88, 20, I18n.format("hats.gui.resetSide")));
        	if(Hats.config.playerHatsMode < 4)
        	{
        		buttonList.add(new GuiSlider(ID_MOB_SLIDER, width / 2 - 6, height / 2 - 78 + (22 * 3), 88, 0, I18n.format("hats.gui.randomobs") + ": ", "%", 0, 100, Hats.config.randomMobHat, false, true, this)); //FIXME height
        	}
        	
        	currentDisplay = I18n.format("hats.gui.personalize");
        }
    }
    ...
    {
    	if(s.equalsIgnoreCase(I18n.format("hats.gui.allHats")))
    	{
    		view = VIEW_COLOURIZER;
    		category = "";
    	...
    	else
    	{
	    	...
	    	if(Hats.config.playerHatsMode >= 4 && !mc.player.capabilities.isCreativeMode)
	    	{
    ...
    public void showCategories()
    {
    	if(view != VIEW_CATEGORIES)
    	{
	    	...
	    	{
	    		hatsToShow.remove(I18n.format("hats.gui.contributors"));
	    	}
    ...
    {
		showCategory(I18n.format("hats.gui.allHats"));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        for (int k1 = 0; k1 < this.buttonList.size(); ++k1)
        {
            ...
            if(btn.id == ID_HAT_COLOUR_SWAP || btn.id == ID_NONE || btn.id == ID_RANDOM || btn.id == ID_HELP || btn.id == ID_RELOAD_HATS || btn.id == ID_FAVOURITES || btn.id == ID_CATEGORIES || btn.id == ID_PERSONALIZE || btn.id == ID_ADD || btn.id == ID_CANCEL || btn.id == ID_RENAME || btn.id == ID_DELETE || btn.id == ID_FAVOURITE || btn.id == ID_SEARCH || btn.id == ID_MAKE_TRADE || btn.id == ID_ACCEPT_TRADE)
            {
	            ...
	            if(btn.visible)
	            {
	            	...
	            	{
	            		drawTexturedModalRect(btn.xPosition + 2, btn.yPosition + 2, view == VIEW_CATEGORY && !category.equalsIgnoreCase("Favourites") && !category.equalsIgnoreCase(I18n.format("hats.gui.contributors")) ? 224 : 160, 0, 16, 16);
	            	}
	            	else if(btn.id == ID_RENAME)
	            	{
        ...
        drawString(fontRendererObj, I18n.format("hats.gui.viewing") + ": " + currentDisplay, this.guiLeft + 1, this.guiTop - 9, 0xffffff);
    ...
    public void drawForeground(int par1, int par2, float par3)
    {
        for (int k1 = 0; k1 < this.buttonList.size(); ++k1)
        {
            ...
            if(btn.isMouseOver() && !personalizing)
            {
	            ...
	            {
	            	drawTooltip(Collections.singletonList("\u00a77" + btn.displayString), par1, par2);
	            }
	            else if(btn.id == ID_CLOSE)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.gui.discardChanges")), par1, par2);
	            }
	            else if(btn.id == ID_NONE)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.gui.removeHat") + " (N)"), par1, par2);
	            }
	            else if(btn.id == ID_HAT_COLOUR_SWAP)
	            {
	            	drawTooltip(Collections.singletonList((view == VIEW_HATS || view == VIEW_CATEGORY ? I18n.format("hats.gui.colorizer") : I18n.format("hats.gui.hatsList")) + " (H)"), par1, par2);
	            }
	            else if(btn.id == ID_RANDOM)
	            {
	            	drawTooltip(Collections.singletonList((view == VIEW_HATS || view == VIEW_CATEGORY ? I18n.format("hats.gui.randomHat") : view == VIEW_CATEGORIES ? I18n.format("hats.gui.randomCategory") : isShiftKeyDown() ? I18n.format("hats.gui.resetColor") : I18n.format("hats.gui.randomColor")) + " (R)"), par1, par2);
	            }
	            else if(btn.id == ID_HELP)
	            {
	            ...
	            {
	            	drawTooltip(Arrays.asList(I18n.format("hats.gui.reloadAllHats"), I18n.format("hats.gui.discardAllChanges")), par1, par2);
	            }
	            else if(btn.id == ID_FAVOURITES)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.gui.favorites") + " (F)"), par1, par2);
	            }
	            else if(btn.id == ID_CATEGORIES)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.gui.categories") + " (C)"), par1, par2);
	            }
	            else if(btn.id == ID_PERSONALIZE)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.gui.personalize") + " (P)"), par1, par2);
	            }
	            else if(btn.id == ID_ADD)
	            {
	            	drawTooltip(Collections.singletonList(adding || renaming ? invalidFolderName ? "\u00a7c" + I18n.format("hats.gui.invalidName") : I18n.format("hats.gui.addCategory") : (view == VIEW_HATS || view == VIEW_CATEGORY && (category.equalsIgnoreCase("Favourites") || category.equalsIgnoreCase(I18n.format("hats.gui.contributors")))) ? I18n.format("hats.gui.addToCategory") : I18n.format("hats.gui.removeFromCategory")), par1, par2);
	            }
	            else if(btn.id == ID_CANCEL)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("gui.cancel")), par1, par2);
	            }
	            else if(btn.id == ID_DELETE)
	            {
	            	if(deleting)
	            	{
	            		drawTooltip(Arrays.asList(I18n.format("hats.gui.areYouSure"), "", I18n.format("hats.gui.clickConfirm")), par1, par2);
	            	}
	            	else if(view == VIEW_CATEGORIES)
	            	{
	            		drawTooltip(Arrays.asList(I18n.format("hats.gui.deleteCategory"), "", I18n.format("hats.gui.deleteCategory.desc1"), I18n.format("hats.gui.deleteCategory.desc2"), I18n.format("hats.gui.deleteCategory.desc3"), "", I18n.format("hats.gui.doubleClickConfirm")), par1, par2);
	            	}
	            	else
	            	{
	            		if(isShiftKeyDown())
	            		{
	            			drawTooltip(Arrays.asList(I18n.format("hats.gui.disableHat"), "", I18n.format("hats.gui.disableHat.desc1"), I18n.format("hats.gui.disableHat.desc2"), I18n.format("hats.gui.disableHat.desc3"), I18n.format("hats.gui.disableHat.desc4"), "", I18n.format("hats.gui.doubleClickConfirm")), par1, par2);
	            		}
	            		else
	            		{
	            			drawTooltip(Arrays.asList(I18n.format("hats.gui.deleteHat"), "", I18n.format("hats.gui.deleteHat.desc1"), I18n.format("hats.gui.deleteHat.desc2"), I18n.format("hats.gui.deleteHat.desc3"), "", I18n.format("hats.gui.doubleClickConfirm")), par1, par2);
	            		}
	            	}
	            }
	            else if(btn.id == ID_RENAME)
	            {
	            	drawTooltip(Arrays.asList(I18n.format("hats.gui.renameCategory"), "", I18n.format("hats.gui.renameCategory.desc1")), par1, par2);
	            }
	            else if(btn.id == ID_FAVOURITE)
	            {
	            	if(!selectedButtonName.equalsIgnoreCase("") && HatHandler.isInFavourites(selectedButtonName))
	            	{
	            		drawTooltip(Collections.singletonList(I18n.format("hats.gui.removeFromFavorites")), par1, par2);
	            	}
	            	else
	            	{
	            		drawTooltip(Collections.singletonList(I18n.format("hats.gui.addToFavorites")), par1, par2);
	            	}
	            }
	            else if(btn.id == ID_RESET_SIDE)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.gui.resetButtonsOnSide")), par1, par2);
	            }
	            else if(btn.id == ID_MAKE_TRADE)
	            {
	            	drawTooltip(Collections.singletonList(I18n.format("hats.trade")), par1, par2);
	            }
	            else if(btn.id == ID_ACCEPT_TRADE)
	            {
	            	drawTooltip(Collections.singletonList(Hats.proxy.tickHandlerClient.tradeReq != null && Hats.proxy.tickHandlerClient.tradeReqTimeout > 0 ? I18n.format("hats.trade.acceptRequestSpecific", Hats.proxy.tickHandlerClient.tradeReq, (int) Math.ceil((double) Hats.proxy.tickHandlerClient.tradeReqTimeout / 20D)) : I18n.format("hats.trade.acceptRequestGeneral")), par1, par2);
	            }
            }
        }
    }
...
//	        GlStateManager.translate(0.0F, hat.parent == hat.renderingParent ? hat.parent.yOffset : 0.0F, 0.0F);
            ...
            Minecraft.getMinecraft().getRenderManager().doRenderEntity(hat.renderingParent, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, false);
...
//	        RenderHelper.disableStandardItemLighting();
            ...
            Minecraft.getMinecraft().getRenderManager().doRenderEntity(hat, 0.0D, /*hat.parent == hat.renderingParent ? 0.0F : hat.parent.yOffset*/ 0.0D, 0.0D, hat.rotationYaw, 1.0F, false);
	...
	private static final String[] helpInfo1 = new String[] {I18n.format("hats.gui.helpInfo1.desc1"), I18n.format("hats.gui.helpInfo1.desc2"), I18n.format("hats.gui.helpInfo1.desc3"), I18n.format("hats.gui.helpInfo1.desc4"), I18n.format("hats.gui.helpInfo1.desc5")};
	private static final String[] helpInfo2 = new String[] {I18n.format("hats.gui.helpInfo2.desc1"), I18n.format("hats.gui.helpInfo2.desc2"), I18n.format("hats.gui.helpInfo2.desc3")};
	private static final String[] helpInfo3 = new String[] {I18n.format("hats.gui.helpInfo3.desc1"), I18n.format("hats.gui.helpInfo3.desc2"), I18n.format("hats.gui.helpInfo3.desc3"), I18n.format("hats.gui.helpInfo3.desc4")};
	private static final String[] helpInfo4 = new String[] {I18n.format("hats.gui.helpInfo4.desc1"), I18n.format("hats.gui.helpInfo4.desc2"), I18n.format("hats.gui.helpInfo4.desc3"), I18n.format("hats.gui.helpInfo4.desc4"), I18n.format("hats.gui.helpInfo4.desc5")};
	private static final String[] helpInfo5 = new String[] {I18n.format("hats.gui.helpInfo5.desc1"), I18n.format("hats.gui.helpInfo5.desc2"), I18n.format("hats.gui.helpInfo5.desc3")};
	private static final String[] helpInfo6 = new String[] {I18n.format("hats.gui.helpInfo6.desc1"), I18n.format("hats.gui.helpInfo6.desc2"), I18n.format("hats.gui.helpInfo6.desc3"), I18n.format("hats.gui.helpInfo6.desc4")};
	private static final String[] helpInfo7 = new String[] {I18n.format("hats.gui.helpInfo7.desc1"), I18n.format("hats.gui.helpInfo7.desc2")};
	private static final String[] helpInfo8 = new String[] {I18n.format("hats.gui.helpInfo8.desc1"), I18n.format("hats.gui.helpInfo8.desc2")};
	private static final String[] helpInfo9 = new String[] {I18n.format("hats.gui.helpInfo9.desc1"), I18n.format("hats.gui.helpInfo9.desc2")};
	private static final String[] helpInfo10 = new String[] {I18n.format("hats.gui.helpInfo10.desc1"), I18n.format("hats.gui.helpInfo10.desc2"), I18n.format("hats.gui.helpInfo10.desc3"), I18n.format("hats.gui.helpInfo10.desc4"), I18n.format("hats.gui.helpInfo10.desc5")};
	private static final String[] helpInfo11 = new String[] {I18n.format("hats.gui.helpInfo11.desc1"), I18n.format("hats.gui.helpInfo11.desc2"), I18n.format("hats.gui.helpInfo11.desc3"), I18n.format("hats.gui.helpInfo11.desc4"), I18n.format("hats.gui.helpInfo11.desc5"), I18n.format("hats.gui.helpInfo11.desc6")};
	private static final String[] helpInfo12 = new String[] {I18n.format("hats.gui.helpInfo12.desc1"), I18n.format("hats.gui.helpInfo12.desc2"), I18n.format("hats.gui.helpInfo12.desc3")};
	private static final String[] helpInfo13 = new String[] {I18n.format("hats.gui.helpInfo13.desc1"), I18n.format("hats.gui.helpInfo13.desc2")};
	private static final String[] helpInfo14 = new String[] {I18n.format("hats.gui.helpInfo14.desc1"), I18n.format("hats.gui.helpInfo14.desc2")};
	private static final String[] helpInfo15 = new String[] {I18n.format("hats.gui.helpInfo15.desc1"), I18n.format("hats.gui.helpInfo15.desc2"), I18n.format("hats.gui.helpInfo15.desc3")};
	private static final String[] helpInfo16 = new String[] {I18n.format("hats.gui.helpInfo16.desc1"), I18n.format("hats.gui.helpInfo16.desc2"), I18n.format("hats.gui.helpInfo16.desc3"), I18n.format("hats.gui.helpInfo16.desc4")};
	private static final String[] helpInfo17 = new String[] {I18n.format("hats.gui.helpInfo17.desc1"), I18n.format("hats.gui.helpInfo17.desc2"), I18n.format("hats.gui.helpInfo17.desc3")};
	private static final String[] helpInfo18 = new String[] {I18n.format("hats.gui.helpInfo18.desc1"), I18n.format("hats.gui.helpInfo18.desc2"), I18n.format("hats.gui.helpInfo18.desc3")};
	private static final String[] helpInfo19 = new String[] {I18n.format("hats.gui.helpInfo19.desc1"), I18n.format("hats.gui.helpInfo19.desc2"), I18n.format("hats.gui.helpInfo19.desc3")};
